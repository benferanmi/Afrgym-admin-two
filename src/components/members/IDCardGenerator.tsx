                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <div className="mt-2">
                    <div className="inline-block px-3 py-1 bg-gradient-to-r from-cyan-50 to-blue-50 rounded-full border border-cyan-200">
                      <p className="text-xs text-cyan-700 font-bold uppercase tracking-wide">
                        ✓ Authorized Member
                      </p>
                    </div>
                  </div>
                ...
                <div className="w-32 flex flex-col items-center justify-center">
                  {getQRCodeUrl() ? (
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-[10px] font-mono font-bold text-gray-700 mt-2 text-center break-all px-1">
                        {getQRUniqueId()}
                      </p>
